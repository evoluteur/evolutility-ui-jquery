...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      demo: {
        options: {
          banner:
            "/* <%= pkg.name %> v<%= pkg.version %> sample UI-models and data: todo, addressbook, wine cellar. */\n ",
          mangle: true,
        },
        files: [
          {
  ...
  grunt.registerTask("dev", ["header:dev", "concat:js", "demo", "sass:dev"]);
  grunt.registerTask("demo", ["concat:demo", "sass:demo", "uglify:demo"]);
  ...
  grunt.registerTask("css", ["sass:dev", "sass:prod", "sass:demo"]);
  grunt.registerTask("js", ["concat:js", "uglify:prod"]);
